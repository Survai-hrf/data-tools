...
def parse_kinetics_splits(level, dataset, custom_annot_name = ''):
    ...
    if custom_annot_name != '':
        train_file = f'/home/bean/code/hrf/datasets/VAR/survai_var_mk1/annotations/{custom_annot_name}_master_train.csv'
        val_file = f'/home/bean/code/hrf/datasets/VAR/survai_var_mk1/annotations/{custom_annot_name}_master_val.csv'
        test_file = f'/home/bean/code/hrf/datasets/VAR/survai_var_mk1/annotations/{custom_annot_name}_master_test.csv'
