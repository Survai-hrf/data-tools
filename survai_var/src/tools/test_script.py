...
def parse_args():
    ...
    parser.add_argument('--clarity', default=['none', 'easy', 'medium'], nargs="*", help='takes a list of clarity levels to prepare. All options ex: ["none","easy","medium","hard","bad_egg"]')
